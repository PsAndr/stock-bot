...
def start():
    ...
    indicators_condition_mass = [{'BB': 'sell', 'Stoch': 'sell', 'Fib_levels': 'sell', 'Supertrend': 'sell'} for i in
                                 range(len(spis))]
    ...
    while True:
        ...
        if dt_now.minute % 15 == 0 and dt_now.second == 0:
            # print(dt_candle)
            #print(f'new step {dt_now}')
            for ind, tic in enumerate(spis):
